        ...
        <ul id="slide-out" class="side-nav fixed custom-scrollbar ps-container ps-theme-default" style="transform: translateX(-100%);" data-ps-id="a3059142-77b4-da24-04a8-3242680b3688">
            ...
            <li>
                <ul class="collapsible collapsible-accordion">
                    ...
                    <li><a class="collapsible-header waves-effect arrow-r" href="<?php echo base_url()."index.php/penerimaan/penerimaan_staf" ?>"><i class="fa fa-credit-card-alt"></i> Data Penerimaan</a></li>
                    <li><a class="collapsible-header waves-effect arrow-r" href="<?php echo base_url()."index.php/stockbarang/stockbarang" ?>"><i class="fa fa-folder"></i> Filter Barang</a></li>
                </ul>
            </li>
            <!--/. Side navigation links -->
