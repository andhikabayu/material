        ...
        <ul id="slide-out" class="side-nav fixed custom-scrollbar ps-container ps-theme-default" style="transform: translateX(-100%);" data-ps-id="a3059142-77b4-da24-04a8-3242680b3688">
            ...
            <li>
                <ul class="collapsible collapsible-accordion">
                    <li><a class="collapsible-header waves-effect arrow-r" href="<?php echo base_url()."index.php/home/home_manager" ?>"><i class="fa fa-home"></i> Home</a>
                    </li>
                    <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-plus"></i> Input<i class="fa fa-angle-down rotate-icon"></i></a>
                        <div class="collapsible-body" style="">
                            <ul>
                                <li><a href="<?php echo base_url()."index.php/user/input_admin" ?>" class="waves-effect">Admin</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li><a class="collapsible-header waves-effect arrow-r" href="<?php echo base_url()."index.php/laporan/laporan_manager" ?>"><i class="fa fa-fax"></i> Laporan</a>
                    </li>
                </ul>
            </li>
            <!--/. Side navigation links -->
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-primary dd-right" aria-labelledby="dropdownMenu1" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                        <a class="dropdown-item waves-effect waves-light" href="<?php echo base_url()."index.php/profil/profil_manager" ?>">Profil</a>
                        <a class="dropdown-item waves-effect waves-light" href="<?php echo base_url()."index.php/profil/edit_profil_manager" ?>">Edit Profil</a>
