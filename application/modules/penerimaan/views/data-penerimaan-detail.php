      ...
      <div class="container">
        <div class="white z-depth-2">
			...
			<div align="center" class="grey darken-3" style="padding:10px;">
			  	<h1 class="white-text">Detail Penerimaan <a class="btn btn-secondary pull-right" href="<?php echo base_url() ?>index.php/penerimaan/"><i class="fa fa-list"></i> Kembali</a></h1>
			</div>
			  <br>
			  <div class="container">
