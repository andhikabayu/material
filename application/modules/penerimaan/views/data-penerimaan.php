		...
		<div class="main-wrapper z-depth-2 white">
    	  <div class="grey darken-3" align="center" style="padding:10px;">
			<h1 class="white-text">Data Penerimaan 
				<a class="btn btn-secondary pull-right" href="<?php echo base_url() ?>index.php/penerimaan/tranpembelian">
				    <i class="fa fa-list left"> Penerimaan Barang</i>
				</a>
			</h1>
	      </div>
	      <br>
        ...
        <div class="table-responsive">
			       <table class="table table-hover thead-inverse z-depth-1 data">
                        ...
                        <tr>
                            ...
                            <td>
 								<a href="<?php echo site_url('penerimaan/detail_penerimaan/'.$row['kd_pembelian']);?>" class="btn btn-sm btn-info" data-toggle="tooltip" data-placement="right" title="Detail"><i class="fa fa-eye"></i></a>
								<a href="<?php echo site_url('penerimaan/edit_penerimaan/'.$row['kd_pembelian']);?>" class="btn btn-sm btn-secondary" data-toggle="tooltip" data-placement="right" title="Edit"><i class="fa fa-pencil"></i></a>
