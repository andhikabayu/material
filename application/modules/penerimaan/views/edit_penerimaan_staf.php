    ...
    <div class="main-wrapper">
      <div class="container-fluid">
        <div class="white z-depth-2">
			<form action="<?php echo base_url() ?>index.php/penerimaan/do_update_penerimaan_staf" method="post">
			<div align="center" class="grey darken-3" style="padding:10px;">
			  	<h1 class="white-text">Edit Penerimaan <a class="btn btn-secondary pull-right" href="<?php echo base_url() ?>index.php/penerimaan/penerimaan_staf"><i class="fa fa-list"></i> Penerimaan</a></h1>
			</div>
			  <br>
			  <div class="container">
