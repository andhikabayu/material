...
<div class="rgba-black-strong">
    ...
    <main class="">
        <div class="container-fluid text-xs-center" style="height: 600px;">
            <br><br><br><br>
            <h1 class="white-text">Selamat Datang Di Halaman Admin</h1>
            <h2 class="white-text">Hay <?php echo $session_data['nama']; ?></h2>
        </div>
    </main>
    <!--/Main layout-->
    ...
    <footer class="page-footer center-on-small-only">
        ...
        <div class="call-to-action">
            <ul>
                <li>
                    <h5>Cari Saya Di social media</h5>
                </li>
            </ul>
        </div>
        <!--/.Call to action-->
        ...
        <div class="footer-copyright">
            <div class="container-fluid">
                © 2020 Copyright: <a href="#"> Material </a>
