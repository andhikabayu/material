                    ...
                    <div class="collapsible-body">
                        <ul>
                           <!--  <li><a href="<?php echo base_url()."index.php/pembelian/tranpembelian" ?>" class="waves-effect">Pembelian</a>
                            ...
                            <li><a href="<?php echo base_url()."index.php/penerimaan/penerimaan" ?>" class="waves-effect">Penerimaan</a></li>
                            <li><a href="<?php echo base_url()."index.php/transaksi" ?>"><i class="waves-effect"></i>Penjualan</a></li>
                            <li><a href="<?php echo base_url()."index.php/transaksi/form_cetakNota" ?>"><i class="waves-effect"></i> Cetak Nota</a></li>
                        </ul>
                    </div>
                </li>
