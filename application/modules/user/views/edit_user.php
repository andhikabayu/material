...
?>
<main>
	<form class="white" method="post" enctype="multipart/form-data" action="<?php echo base_url()."index.php/user/do_update_user"; ?>">    
	  ...
	  <div class="row">
	  	...
	  	<div align="center">
			...
			<a href="<?php echo base_url() ?>index.php/user/input_user" class="btn btn-danger btn-md">Batal</a>
		</div>
		<br>
	  </div>
	</form>
