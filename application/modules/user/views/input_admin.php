    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Masukan Admin</h4>
            </div>
            <!--Body-->
            <div class="modal-body">
                <br>
                <form method="post" enctype="multipart/form-data" action="<?php echo base_url()."index.php/user/do_insert_admin"; ?>">    
                      <br>
                      <div class="container">
...
<main>
    ...
    <div align="center" class="grey darken-3" style="padding:10px;">
         <h1 class="white-text">Data Admin <button type="button" class="btn btn-info pull-right secondary" data-toggle="modal" data-target="#modal-contact"><i class="fa fa-plus"></i> Admin</button></h1>
    </div>
                    ...
                    <table class="table table-hover thead-inverse z-depth-1" id="data">
						...
						<tbody>
							...
							<tr data-id="<?php echo $user['id_user'] ?>">
								...
								<td>
									<a class="btn btn-sm btn-default waves-effect" href="<?php echo base_url()."index.php/user/editadmin/".$user['id_user']; ?>"><i class="fa fa-edit"></i></a>
