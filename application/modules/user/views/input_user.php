    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Masukan User</h4>
            </div>
            <!--Body-->
            <div class="modal-body">
                <br>
                <form name="frm" method="post" enctype="multipart/form-data" action="<?php echo base_url()."index.php/user/do_insert_user"; ?>">    
                      <br>
                      <div class="container">
                        <div class="col-md-12">
					   ...
					   <div class="col-md-12">
						<div class="md-form col-md-6">
						    <input type="password" id="form1" name="password" class="form-control" onChange="cekPass();" required>
						    <label for="form1" class="">Password</label>
						</div>
						<div class="md-form col-md-6">
						    <input type="password" id="form1" name="password2" class="form-control" onChange="cekPass();" required>
						    <label for="form1" class="">Konfirmasi Password</label>
					   ...
					   <div class="md-form col-md-6">
						...
						<div class="col-md-6">
							<select class="mdb-select" name="id_level" required>
                                <option value="" disabled selected>Pilih level</option>
                                <?php
                                foreach ($datalevel as $d) {
                                if($d['kd_level']==1){}elseif($d['kd_level']==2){}else{
                                ?>
                                <option value="<?PHP echo $d['kd_level'] ?>"><?php echo $d['level']?></option>
                            	<?php } } ?>
                            </select>
                            <label>Level</label>
					    </div>
...
<main>
    ...
    <div align="center" class="grey darken-3" style="padding:10px;">
         <h1 class="white-text">Data User <button type="button" class="btn btn-info pull-right secondary" data-toggle="modal" data-target="#modal-contact"><i class="fa fa-plus"></i> User</button></h1>
    </div>
        ...
        <div class="row table-responsive">
                    ...
                    <table class="table table-hover thead-inverse z-depth-1" id="data">
						...
						<tbody>
							<?php 
								$no=0;
								foreach ($qwuser as $user) {
							 	$no++;
							 if($user->id_level==1){}elseif($user->id_level==2){}else{
							 ?>
							<tr data-id="<?php echo $user->id_user ?>">
								...
								<td>
									<a class="btn btn-sm btn-default waves-effect" href="<?php echo base_url()."index.php/user/edituser/".$user->id_user; ?>"><i class="fa fa-edit"></i></a>
    ...
    <script> 
     function cekPass() { 
     	...
     	if(p1==p2) { 
			...
			txt = "Password Tidak Sama";
     		document.frm.simpan.disabled=true;
