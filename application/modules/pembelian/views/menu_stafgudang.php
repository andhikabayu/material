        ...
        <ul id="slide-out" class="side-nav fixed custom-scrollbar ps-container ps-theme-default" style="transform: translateX(-100%);" data-ps-id="a3059142-77b4-da24-04a8-3242680b3688">
            ...
            <li>
                <ul class="collapsible collapsible-accordion">
                    <li><a class="collapsible-header waves-effect arrow-r" href="<?php echo base_url()."index.php/home/home_stafgudang" ?>"><i class="fa fa-home"></i> Home</a>
                    </li>
                    ...
                    <div class="collapsible-body">
                        <ul>
                            <li><a href="<?php echo base_url()."index.php/stockbarang/indexgudang" ?>" class="waves-effect">Rak Penyimpanan</a></li>
                        </ul>
                    </div>
                    </li>
                    <li><a class="collapsible-header waves-effect arrow-r" href="<?php echo base_url()."index.php/pembelian/" ?>"><i class="fa fa-credit-card-alt"></i> Transaksi Penerimaan</a></li>
                    <li><a class="collapsible-header waves-effect arrow-r" href="<?php echo base_url()."index.php/penerimaan/penerimaan_staf" ?>"><i class="fa fa-folder"></i> Data Penerimaan</a></li>
                    <li><a class="collapsible-header waves-effect arrow-r" href="<?php echo base_url()."index.php/stockbarang/stockbarang" ?>"><i class="fa fa-credit-card-alt"></i> Filter Barang</a></li>
                </ul>
            </li>
            <!--/. Side navigation links -->
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-primary dd-right" aria-labelledby="dropdownMenu1" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                        <a class="dropdown-item waves-effect waves-light" href="<?php echo base_url()."index.php/profil/profil_stafgudang" ?>">Profil</a>
                        <a class="dropdown-item waves-effect waves-light" href="<?php echo base_url()."index.php/profil/edit_profil_stafgudang" ?>">Edit Profil</a>
