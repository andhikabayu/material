        ...
        <div class="white z-depth-2">
			    ...
			    <form method="post" enctype="multipart/form-data" action="<?php echo base_url()."index.php/penerimaan/insert_penerimaan" ?>" id="formpembelian">
					  <div align="center" class="grey darken-3" style="padding:10px;">
					  	<h1 class="white-text">Transaksi Penerimaan <a class="btn btn-secondary pull-right" href="<?php echo base_url() ?>index.php/penerimaan/"><i class="fa fa-list"></i> Penerimaan</a></h1>
					  </div>
					  <br>
					  <div class="container">
